      ...
      <form onSubmit={handleSubmit} className="p-4 border-t">
        <div className="flex items-center relative">
            ...
            <input
                ...
                className="flex-1 py-2 pl-12 pr-12 pb-12 w-full border rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--dark-btn)] max-sm:text-sm text-slate-600"
                disabled={isLoading}
            />
            <span className="absolute bottom-2 left-13 flex justify-end">
              <button
                ...
                className={`${isVectorSearch ? "bg-gray-700/70" : "bg-gray-700/50"} text-slate-200 px-2 py-1.5 rounded-full hover:bg-opacity-90 transition-colors text-xs flex items-center gap-2 justify-center h-fit cursor-pointer`}
              >
                <Database size={12}/>
                Vector Search
              </button>
