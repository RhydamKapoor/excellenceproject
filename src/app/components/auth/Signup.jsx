      ...
      <div className="flex flex-col gap-y-2 text-[var(--withdarktext)]">
        ...
        <div className="flex *:w-1/2 gap-x-3">
            <div className="flex flex-col">
                <div className="flex flex-col relative">
                    ...
                    <label htmlFor="firstName" className={`"capitalize absolute top-1/2 -translate-y-1/2 left-5 bg-[var(--ourbackground)] px-1 transition-all duration-200 peer-focus:-translate-y-8.5 peer-focus:scale-90 peer-focus:-translate-x-2 ${watch("firstName") && `-translate-x-2 scale-90 -translate-y-8.5`}`}>First Name</label>
                </div>
            ...
            <div className="flex flex-col">
                <div className="flex flex-col relative">
                    ...
                    <label htmlFor="lastName" className={`capitalize absolute top-1/2 -translate-y-1/2 left-5 peer-focus:-translate-y-8.5 peer-focus:scale-90 peer-focus:-translate-x-2 bg-[var(--ourbackground)] px-1 transition-all duration-200 ${watch("lastName") && `-translate-x-2 scale-90 -translate-y-8.5`}`}>last Name</label>
                </div>
        ...
        <div className="flex flex-col">
            <div className="flex flex-col relative">
                ...
                <label htmlFor="email" className={`capitalize absolute top-1/2 -translate-y-1/2 left-5 peer-focus:-translate-y-8.5 peer-focus:scale-90 peer-focus:-translate-x-2 bg-[var(--ourbackground)] px-1 transition-all duration-200 ${watch("email") && `-translate-x-2 scale-90 -translate-y-8.5`}`}>email</label>
            </div>
        ...
        <div className="flex flex-col">
            <div className="flex flex-col relative">
                ...
                <label htmlFor="password" className={`capitalize absolute top-1/2 -translate-y-1/2 left-5 peer-focus:-translate-y-8.5 peer-focus:scale-90 peer-focus:-translate-x-2 bg-[var(--ourbackground)] px-1 transition-all duration-200 ${watch("password") && `-translate-x-2 scale-90 -translate-y-8.5`}`}>password</label>
        ...
        <div className="flex flex-col">
          ...
          <p className={`${errors?.role ? `visible` : `invisible`} pl-2 text-red-500 text-sm`}>{errors?.role?.message || `Error`}</p>
        </div>
